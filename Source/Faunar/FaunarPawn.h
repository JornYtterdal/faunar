...
#include "FaunarPawn.generated.h"

UCLASS(Blueprintable)
class AFaunarPawn : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(Category = Faunarplay, EditAnywhere, BlueprintReadWrite)
		FVector GunOffset;
	...
	// Called when the Faunar starts or when spawned
